...
class MyMenu extends StatelessWidget {
  const MyMenu({super.key, this.title, this.icon, this.color, this.onTap, this.isLong = false});
  final String? title;
  final IconData? icon;
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(isLong ? 30.0 : 8.0),
      ),
      child: InkWell(
        onTap: onTap,
        borderRadius: BorderRadius.circular(isLong ? 30.0 : 8.0),
        ...
        child: Stack(
          ...
          children: [
            ...
            Container(
              ...
              color: Colors.blue,
              child: const Center(
                child: Text('Akmal', style: TextStyle(color: Colors.white)),
              ),
            ),
          ],
        ),
          ...
          child: Column(
            ...
            children: [
              CircleAvatar(
                radius: 50,
              backgroundColor: Colors.red,
                backgroundImage: AssetImage("assets/images/akmal.jpeg"),
              ),
              SizedBox(height: 20),
              Text(
                "Muhammad Akmal Palqah",
